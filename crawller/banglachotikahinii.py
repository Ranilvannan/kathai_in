...
class BanglaChotikahinii(models.TransientModel):
    _name = "bangla.chotikahinii"
    _description = "Banglachotikahinii"
    ...
    def create_article(self, soup):
        ...
        for article in article_list:
            ...
            if not rec:
                ...
                language = self.env["story.language"].search([("code", "=", "BENGALI")])
